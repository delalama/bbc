class shortcut {
    constructor(family, action, shortcut) {
        this.family = family;
        this.action = action;
...
function showRandomShortcut() {
    ...
    setTimeout(function () {
        const shortcutString = getRandomShortcut();

         var shortcut = createNewShortcut(shortcutString);
         
        document.getElementById("shortcutFamily").innerHTML = shortcut.family.toUpperCase();
        document.getElementById("shortcutAction").innerHTML = shortcut.action.toUpperCase();
        document.getElementById("shortcutShortcut").innerHTML = shortcut.shortcut.toUpperCase();
...
function createNewShortcut(shortcutString) {
...
function getRandomShortcut() {
    const randomNum = getRndInteger(0, allShortcuts.length);

    return allShortcuts[randomNum];
}
